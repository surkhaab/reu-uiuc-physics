...
Arguments:
    --obstacle   Obstacle type: 'cylinder' (default). More types can be added later.
...
OBSTACLE_REGISTRY = {
    "cylinder": GenerateCylinderObstacle,
    # Add more here: "square": GenerateSquareObstacle, etc.
}
...
def main():
    ...
    parser.add_argument("--obstacle", default="cylinder",
                        choices=list(OBSTACLE_REGISTRY.keys()),
                        help="Obstacle shape (default: cylinder)")
    ...
    fin       = Setup()
    feq_init  = fin.copy()
    obstacle  = OBSTACLE_REGISTRY[args.obstacle]()
